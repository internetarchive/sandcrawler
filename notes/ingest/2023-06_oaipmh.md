...
On 2023-08-16, we have the following sitatation:
...
5M already preserved URLs which we may crawl.
    ...
    -----------------------+----------
     ...
     success               |  2629324
     no-pdf-link           |  1694308
     terminal-bad-status   |   144140
     empty-blob            |    49475
     wrong-mimetype        |    41300
     blocked-wall          |    23341
     link-loop             |    23322
     skip-url-blocklist    |    20878
     redirect-loop         |    16694
     petabox-error         |    10850
     wayback-error         |     9567
     blocked-cookie        |     9557
     wayback-content-error |     3152
     body-too-large        |     3114
     cdx-error             |     3091
     bad-gzip-encoding     |      170
     bad-redirect          |      133
     skip-wall             |       24
     redirects-exceeded    |       18
    (20 rows)
...
Dump partial results again for crawling:
    ...
    WHERE
      ingest_request.ingest_type = 'pdf'
      AND ingest_request.link_source = 'oai'
      AND dat e (ingest_request.created) > '2023-07-28'
      AND (ingest_file_result.status = 'no-capture'
        OR ingest_file_result.status = 'cdx-error'))
    TO '/tmp/oai_tocrawl_20230816.rows.json';
