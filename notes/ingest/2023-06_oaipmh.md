...
On 2023-08-14, after about two weeks, we have the following situation:

	sandcrawler=# SELECT ingest_file_result.status, COUNT(*) FROM
    ingest_request LEFT JOIN ingest_file_result ON ingest_file_result.ingest_type =
    ingest_request.ingest_type  AND ingest_file_result.base_url =
    ingest_request.base_url WHERE ingest_request.ingest_type = 'pdf'      AND
    ingest_request.link_source = 'oai'   AND ingest_file_result.updated >
    '2023-07-31'  GROUP BY status   ORDER BY COUNT DESC  LIMIT 20;
	...
	-----------------------+----------
	 ...
	 success               |  2210084
	 no-pdf-link           |  1421376
	 terminal-bad-status   |   121072
	 empty-blob            |    41625
	 wrong-mimetype        |    34713
	 blocked-wall          |    19664
	 link-loop             |    19581
	 skip-url-blocklist    |    17615
	 redirect-loop         |    14145
	 petabox-error         |     9676
	 blocked-cookie        |     8072
	 wayback-error         |     7978
	 body-too-large        |     2636
	 cdx-error             |     2558
	 wayback-content-error |     2000
	 bad-gzip-encoding     |      145
	 bad-redirect          |      122
	 skip-wall             |       18
	 redirects-exceeded    |       14
	(20 rows)
...
Some sandcrawler worker error for later inspection:

```
Aug 16 20:12:43 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   URL: https://digitalcommons.olivet.edu/cgi/viewcontent.cgi?article=4412&context=dj1
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: Traceback (most recent call last):
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "./sandcrawler_worker.py", line 495, in <module>
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     main()
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "./sandcrawler_worker.py", line 491, in main
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     args.func(args)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "./sandcrawler_worker.py", line 286, in run_ingest_file
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     pusher.run()
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/workers.py", line 578, in run
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     self.worker.push_record_timeout(
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/workers.py", line 79, in push_record_timeout
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     resp = self.push_record(task, key=key)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/workers.py", line 39, in push_record
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     result = self.process(task, key=key)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/ingest_file.py", line 576, in process
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     return self.process_file(request, key=key)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/ingest_file.py", line 646, in process_file
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     resource = self.find_resource(
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/ingest_file.py", line 270, in find_resource
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     resource = self.wayback_client.lookup_resource(url, best_mimetype)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/ia.py", line 838, in lookup_resource
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     resource = self.fetch_petabox(
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/sandcrawler/ia.py", line 563, in fetch_petabox
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     body = gwb_record.open_raw_content().read()
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/.venv/lib/python3.8/site-packages/wayback/resource.py", line 481, in read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     return httplib.HTTPResponse.read(self, amt)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/usr/lib/python3.8/http/client.py", line 472, in read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     s = self._safe_read(self.length)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/.venv/lib/python3.8/site-packages/wayback/resource.py", line 475, in _safe_read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     return httplib.HTTPResponse._safe_read(self, amt)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/usr/lib/python3.8/http/client.py", line 613, in _safe_read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     data = self.fp.read(amt)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/.venv/lib/python3.8/site-packages/hanzo/warctools/stream.py", line 149, in read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     return self._read(read_size)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:   File "/1/srv/sandcrawler/src/python/.venv/lib/python3.8/site-packages/hanzo/warctools/stream.py", line 125, in _read
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]:     result = self.fh.read(count)
Aug 16 20:12:45 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: MemoryError
Aug 16 20:12:46 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: %4|1692216766.638|TERMINATE|rdkafka#producer-1| [thrd:app]: Producer terminating with 1 message (1128 bytes) still in queue or transit: use flush() to wait for outstanding message delivery
Aug 16 20:12:46 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: %4|1692216766.676|TERMINATE|rdkafka#producer-2| [thrd:app]: Producer terminating with 1 message (36399 bytes) still in queue or transit: use flush() to wait for outstanding message delivery
Aug 16 20:12:46 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: %4|1692216766.677|TERMINATE|rdkafka#producer-4| [thrd:app]: Producer terminating with 1 message (9427 bytes) still in queue or transit: use flush() to wait for outstanding message delivery
Aug 16 20:12:46 wbgrp-svc506.us.archive.org sandcrawler-ingest[1544792]: %4|1692216766.679|TERMINATE|rdkafka#producer-3| [thrd:app]: Producer terminating with 1 message (673361 bytes) still in queue or transit: use flush() to wait for outstanding message delivery
``
...
On 2023-08-17, we have the following sitatation:
...
We do a cut here, as processing the full list may take too long now. The
tradeoff is that we may have more duplicates.

Estimated number of duplicates is about 16% of the links. So we may have about
5M already preserved URLs which we may crawl.


    sandcrawler=# SELECT ingest_file_result.status, COUNT(*) FROM ingest_request LEFT JOIN ingest_file_result ON ingest_file_result.ingest_type = ingest_request.ingest_type  AND ingest_file_result.base_url = ingest_request.base_url WHERE ingest_request.ingest_type = 'pdf'      AND ingest_request.link_source = 'oai'   AND ingest_file_result.updated > '2023-07-31'  GROUP BY status   ORDER BY COUNT DESC  LIMIT 20;
    ...
    -----------------------+----------
     ...
     success               |  2779342
     no-pdf-link           |  1790611
     terminal-bad-status   |   152292
     empty-blob            |    52206
     wrong-mimetype        |    43540
     link-loop             |    24678
     blocked-wall          |    24626
     skip-url-blocklist    |    22106
     redirect-loop         |    17618
     petabox-error         |    11353
     wayback-error         |    10100
     blocked-cookie        |    10045
     wayback-content-error |     3279
     body-too-large        |     3270
     cdx-error             |     3258
     bad-gzip-encoding     |      181
     bad-redirect          |      132
     skip-wall             |       26
     redirects-exceeded    |       20
    (20 rows)


Since not all ingest request have been added, we need to:

* [ ] dump ingest request we have
* [ ] take the original URL list and remove all but the "no-capture" and "cdx-error" links
* [ ] do a final round of filtering of noticable domains


Dump partial results again for crawling:

    martin@martin-dev: ~ $ time ssh wbgrp-svc506.us.archive.org "sudo -u postgres psql -d sandcrawler -c \"
    COPY (
      SELECT
        ROW_TO_JSON(ingest_request.*)
      FROM
        ingest_request
      LEFT JOIN ingest_file_result ON ingest_file_result.ingest_type = ingest_request.ingest_type
        AND ingest_ file_result.base_url = ingest_request.base_url
    WHERE
      ingest_request.ingest_type = 'pdf'
      AND ingest_request.link_source = 'oai'
      AND dat e (ingest_request.created) > '2023-07-10'
      AND (ingest_file_result.status = 'no-capture'
        OR ingest_file_result.status = 'cdx-error'))
    TO STDOUT;

    \"" | zstd -T0 -c > /tmp/oai_tocrawl_20230817.rows.json.zst

Ok, dumped 14050468 ingest requests. We need all the links for which we do not have an ingest request for.

Check expected count:

	sandcrawler=# select count(*) from ingest_request as ireq LEFT OUTER JOIN
    ingest_file_result as ifr ON ifr.base_url = ireq.base_url WHERE
    ireq.ingest_type = 'pdf' and ireq.link_source = 'oai' and ireq.created >
    '2023-07-10' and (ifr.status IS NULL or ifr.status IN ('no-capture',
    'cdx-error'));
...
Dump all ingest request, that do not have a ingest result.
    ...
    COPY (
      ...
      FROM
        ingest_request
      LEFT OUTER JOIN ingest_file_result ON ingest_file_result.ingest_type = ingest_request.ingest_type
        AND ingest_ file_result.base_url = ingest_request.base_url
    WHERE
      ingest_request.ingest_type = 'pdf'
      AND ingest_request.link_source = 'oai'
      AND date (ingest_request.created) > '2023-07-10'
      AND (ingest_file_result.status IS NULL
        OR ingest_file_result.status IN ('no-capture', 'cdx-error')
	))
    TO STDOUT;

    \"" | zstd -T0 -c > /tmp/oai_tocrawl_filtered_20230817.rows.json.zst

We expect around 45M rows.

	martin@martin-dev:~$ zstdcat -T0 /tmp/oai_tocrawl_filtered_20230817.rows.json.zst | pv -l | wc -l
	45459394

Needed to unescape via `grep -v "\\\\"`.

Final round of inspection:

    time zstdcat -T0 /tmp/oai_tocrawl_filtered_20230817.rows.json.zst |
		grep  -v "\\\\" | jq -rc .base_url | awk -F / '{print $3}' |
        LC_ALL=C sort -S50% | uniq -c |
        LC_ALL=C sort -nr > /tmp/oai_tocrawl_filtered_20230817.domains.tsv

Finding about 130K domains.

Top 40 domains:

    1941391 hal.science
    1025870 www.persee.fr
     791016 dialnet.unirioja.es
     712363 publications.rwth-aachen.de
     681843 www.redalyc.org
     623316 acikbilim.yok.gov.tr
     580542 curis.ku.dk
     542031 lawcat.berkeley.edu
     452852 sbc.org.pl
     427077 research.vu.nl
     414000 nbn-resolving.org
     408763 openrepository.ru
     405132 bvpb.mcu.es
     383443 research-information.bris.ac.uk
     379677 www.scopus.com
     363014 juser.fz-juelich.de
     340652 jbc.bj.uj.edu.pl
     339349 shs.hal.science
     335974 research.rug.nl
     334189 research.tue.nl
     318320 theses.hal.science
     274657 bib-pubdb1.desy.de
     268449 ntur.lib.ntu.edu.tw
     266851 repository.gsi.de
     251569 www.juntadeandalucia.es
     244336 research.manchester.ac.uk
     243586 hal.inrae.fr
     243316 cris.maastrichtuniversity.nl
     243052 sitereports.nabunken.go.jp
     237270 urn.kb.se
     233769 openresearch-repository.anu.edu.au
     232100 apps.who.int
     220363 server15795.contentdm.oclc.org
     202470 urn.nsk.hr
     199972 orbit.dtu.dk
     194736 galenet.galegroup.com
     193920 bibliotecavirtual.defensa.gob.es
     187245 id.nii.ac.jp
     182879 nl.sub.uni-goettingen.de
     177620 pergamos.lib.uoa.gr

To exclude (manual inspection):
     ...
     187245 id.nii.ac.jp
     177620 pergamos.lib.uoa.gr
     145841 search.ebscohost.com
     108331 zir.nsk.hr
     107511 www.bibliotekacyfrowa.pl
      92612 search.proquest.com
      61060 d.g.wanfangdata.com.cn
      41991 www.bibliotecavirtualdeandalucia.es
      40027 bibliotekacyfrowa.eu
      51819 congressional.proquest.com
      36985 zbc.uz.zgora.pl
      31157 jbc.jelenia-gora.pl
      30526 www.mapress.com
      29392 backend.orbit.dtu.dk
      26912 digital.deutsches-museum.de
      25451 dlibra.bibliotekaelblaska.pl
      22529 aquaticcommons.org
      20151 gateway.proquest.com
      13437 www.llmc.com
      12964 cdm16829.contentdm.oclc.org
      11136 obc.opole.pl
       9622 llmc.com
       9062 czasopisma.kul.pl
       8393 zbc.ksiaznica.szczecin.pl
       2695 cdm15782.contentdm.oclc.org
        852 cdm16629.contentdm.oclc.org
        397 teva.contentdm.oclc.org
        347 phsg.contentdm.oclc.org
         25 aleph.ksiaznica.szczecin.pl
         18 cdm15025.contentdm.oclc.org

Reduced list of urls by about 5M to 40M.

```
$ zstdcat -T0 oai_tocrawl_filtered_20230817.rows.json.zst | grep -v '\\\\' | grep -v -f oai_exclude_list.txt | zstd -c -T0 > oai_tocrawl_reduced_20230817.rows.json.zst
```

Finally, we have ~40M links, about 5.5M seemingly direct pdf urls, about 5M
links to OJS systems. After deduplication, we have 38362590 urls.

* unique urls: 38362590
* urls ending in ".pdf": 5299059
* urls containing "/index.php/" (ojs): 5722302
* distinct domains: 138659

top 40 tlds:

```
martin@martin-dev:/tmp$ rev oai_tocrawl_reduced_20230817_domains.tsv | cut -d . -f 1 | rev | sort | uniq -c | sort -nr | head -40
  26325 org
  20907 com
  17280 de
   5124 fr
